...
const StyledWrapper = styled.div`
  button {
    ...
    color: white;
    background: #220646;
    background: linear-gradient(53deg, rgba(34, 6, 70, 1) 0%, rgba(73, 8, 97, 1) 100%);
    border: none;
    letter-spacing: 0.05em;
    border-radius: 10px;
    box-shadow: -1px 0px 19px 0px rgba(183,47,194,0.45);
    -webkit-box-shadow: -1px 0px 19px 0px rgba(183,47,194,0.45);
    -moz-box-shadow: -1px 0px 19px 0px rgba(183,47,194,0.45);
  }
